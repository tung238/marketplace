...
using TNMarketplace.Web.SignalR;
...
namespace TNMarketplace.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                configuration.RootPath = "ClientApp/dist/TNMarketplace";
            });

            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new Info { Title = "TNMarketplace", Version = "v1" });
            ...
            app.UseSpa(spa =>
                      {
                          ...
                          // [1] In TNMarketplace.csproj, change the <BuildServerSideRenderer> property
